...
func (s *Store) BotUser() storage.IBotUserStorage {
	return NewBotUserRepo(s.pool, s.log)
}
...
func (s *Store) Watermark() storage.IWatermarkStorage {
	return NewWatermarkRepo(s.pool, s.log)
}

func (s *Store) Unlock() storage.IUnlockStorage {
